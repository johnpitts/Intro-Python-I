...
def print_tuple(aTupleInput):
    for i in range(len(aTupleInput)):
        print(str(aTupleInput[i]))
...
u = (1,)  # What needs to be added to make this work?   Yeah, this is dumb, but it must be for a reason?
print("here is 2nd part \n")
print_tuple(u)
